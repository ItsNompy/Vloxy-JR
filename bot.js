...
const CONFIG = {
    ...
    WIN_LOSS_CHANNEL_ID: '1493791636159729684',
...
// Auto-react to messages in the win/flat/loss channel
client.on('messageCreate', async (message) => {
    if (message.channelId === CONFIG.WIN_LOSS_CHANNEL_ID && !message.author.bot) {
        try {
            await message.react('🟢');
            await message.react('🟡');
            await message.react('🔴');
